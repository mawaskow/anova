...
def anovadisp(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,w,x,y):
    ...
    r1 = Text(Point(x/3, 230), a).draw(w)
    r2 = Text(Point(x/3 +140, 230), b).draw(w)
    r3 = Text(Point(x/3 +280, 230), c).draw(w)
    r4 = Text(Point(x/3 +420, 230), d).draw(w)
    r5 = Text(Point(x/3 +560, 230), e).draw(w)
    line5 = Text(Point(x/3 +280, 245), "-"*140).draw(w)
    r6 = Text(Point(x/3, 260), f).draw(w)
    r7 = Text(Point(x/3 +140, 260), g).draw(w)
    r8 = Text(Point(x/3 +280, 260), h).draw(w)
    r9 = Text(Point(x/3 +420, 260), i).draw(w)
    r10 = Text(Point(x/3 +560, 260), str(round(j, 2))).draw(w)
    r11 = Text(Point(x/3, 280), k).draw(w)
    r12 = Text(Point(x/3 +140, 280), l).draw(w)
    r13 = Text(Point(x/3 +280, 280), m).draw(w)
    r14 = Text(Point(x/3 +420, 280), str(round(n, 1))).draw(w)
    line5 = Text(Point(x/3 +280, 295), "-"*140).draw(w)
    r15 = Text(Point(x/3, 310), o).draw(w)
    r16 = Text(Point(x/3 +140, 310), p).draw(w)
    r17 = Text(Point(x/3 +280, 310), q).draw(w)
    line10=Text(Point(x/2,340),("The value for F at alpha = 0.05 is: " + str(r) + (" "*70))).draw(w)
    if (float(j) > float(r)):
        line11 = Text(Point(x/2,365),("There IS a significant statistical difference between the datasets." + (" "*25))).draw(w)
    else:
        line11 =Text(Point(x/2,365),("There is NOT a significant statistical difference between the datasets." + (" "*25))).draw(w)
